...
[.contract]
[[Multisig]]
=== `++Multisig++` link:git+https://github.com/aragon/multisig-plugin/blob/v1.4.0/src/Multisig.sol[{github-icon},role=heading-link]
...
[.contract]
[[MultisigSetup]]
=== `++MultisigSetup++` link:git+https://github.com/aragon/multisig-plugin/blob/v1.4.0/src/MultisigSetup.sol[{github-icon},role=heading-link]
...
=== `++ListedCheckCondition++` link:git+https://github.com/aragon/multisig-plugin/blob/v1.4.0/src/ListedCheckCondition.sol[{github-icon},role=heading-link]
