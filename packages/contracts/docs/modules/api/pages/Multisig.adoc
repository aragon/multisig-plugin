...
[.contract]
[[Multisig]]
=== `++Multisig++` link:https://github.com/aragon/multisig-plugin/blob/1.4.0-alpha.1/packages/contracts/src/Multisig.sol[{github-icon},role=heading-link]
...
[.contract]
[[MultisigSetup]]
=== `++MultisigSetup++` link:https://github.com/aragon/multisig-plugin/blob/1.4.0-alpha.1/packages/contracts/src/MultisigSetup.sol[{github-icon},role=heading-link]
...
=== `++ListedCheckCondition++` link:https://github.com/aragon/multisig-plugin/blob/1.4.0-alpha.1/packages/contracts/src/ListedCheckCondition.sol[{github-icon},role=heading-link]
